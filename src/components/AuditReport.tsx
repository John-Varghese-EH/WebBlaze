  ...
  return (
    <div id="audit-results" className="w-full max-w-7xl mx-auto mt-16 animate-in fade-in slide-in-from-bottom-8 duration-700">
         ...
         <div className="mb-8 flex justify-end">
            <form onSubmit={handleCompare} className="flex flex-col sm:flex-row gap-2 relative z-10 w-full sm:w-auto">
              ...
              <button 
                type="submit" 
                disabled={!compareUrl}
                className="bg-white/10 hover:bg-white/20 text-white font-mono text-sm px-4 py-2 rounded-lg flex items-center justify-center gap-2 border border-white/10 transition-colors disabled:opacity-50"
              >
      ...
      {compareResult && (
         <div className="mb-4 flex justify-end">
            <button 
                ...
                className="bg-white/5 hover:bg-white/10 text-[var(--color-brand-muted)] font-mono text-xs px-3 py-1.5 rounded flex items-center gap-2 border border-white/10"
              >
      ...
      <div className="space-y-8">
        <h3 className="text-3xl font-bold text-white mt-16 mb-8">SEO & AI optimization roadmap</h3>
      ...
      <h3 className="text-3xl font-bold text-white mt-24 mb-8">Your strengths and weaknesses in detail</h3>
      
      <div className="grid md:grid-cols-2 gap-8">
        
        {/* Technical */}
        <div className="bg-[var(--color-brand-charcoal-light)] rounded-2xl border border-white/5 p-8">
          <div className="flex justify-between items-center mb-6">
            <h4 className="text-xl font-bold text-white">Technical Foundation</h4>
            <span className="text-2xl font-black text-[var(--color-brand-green)]">100%</span>
          </div>
          <p className="text-gray-400 text-sm mb-6">The engine of your site. If it's slow, visitors and bots leave.</p>
        ...
        <div className="bg-[var(--color-brand-charcoal-light)] rounded-2xl border border-white/5 p-8">
          <div className="flex justify-between items-center mb-6">
            <h4 className="text-xl font-bold text-white">SEO semantics</h4>
            <span className={`text-2xl font-black ${m.seoScore > 15 ? 'text-[var(--color-brand-green)]' : 'text-[var(--color-brand-red)]'}`}>{m.seoScore * 5}%</span>
          </div>
          <p className="text-gray-400 text-sm mb-6">Your words and titles. Are they neatly arranged for Google?</p>
        ...
        <div className="bg-[var(--color-brand-charcoal-light)] rounded-2xl border border-white/5 p-8">
          <div className="flex justify-between items-center mb-6">
            <h4 className="text-xl font-bold text-white">AI understanding</h4>
        ...
        <div className="bg-[var(--color-brand-charcoal-light)] rounded-2xl border border-white/5 p-8">
          <div className="flex justify-between items-center mb-6">
            <h4 className="text-xl font-bold text-white">Trust & Authority</h4>
            <span className={`text-2xl font-black text-[var(--color-brand-green)]`}>{m.trustAuthority}%</span>
          </div>
          <p className="text-gray-400 text-sm mb-6">Your online reputation. Do you have legal pages?</p>
        ...
        <div className="bg-[var(--color-brand-charcoal-light)] rounded-2xl border border-white/5 p-8">
          <div className="flex justify-between items-center mb-6">
            <h4 className="text-xl font-bold text-white">Business activation</h4>
          ...
          <p className="text-gray-400 text-sm mb-6">Taking action. Is it easy for a human to contact you?</p>
          <div className="space-y-4">
        ...
        <div className="bg-[var(--color-brand-charcoal-light)] rounded-2xl border border-white/5 p-8">
          <div className="flex justify-between items-center mb-6">
            <h4 className="text-xl font-bold text-white">Brand Imprint</h4>
            <span className={`text-2xl font-black ${m.brandImprint! > 50 ? 'text-[var(--color-brand-green)]' : 'text-yellow-500'}`}>{m.brandImprint}%</span>
          </div>
          <p className="text-gray-400 text-sm mb-6">Your public image. Are your links ready to share visually?</p>
          <div className="space-y-4">
      ...
      {/* Extended AI Reports */}
      <h3 className="text-3xl font-bold text-white mt-24 mb-6 relative">
      ...
      <p className="text-gray-400 text-lg mb-8 max-w-4xl">Low reliability estimate based on available signals. This analysis assesses your site's ability to occupy a distinct conversational space in engines and AI.</p>
      
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        <div className="bg-[var(--color-brand-charcoal-light)] rounded-2xl border border-white/5 p-8 flex flex-col justify-center row-span-2">
          ...
          <div className="text-6xl font-black text-[var(--color-brand-red)] tracking-tighter mb-4"><CountUp end={45} /> <span className="text-2xl text-gray-600">/100</span></div>
          <span className="px-3 py-1 bg-white/5 text-gray-300 rounded border border-white/10 self-start text-xs font-bold font-mono">Degraded Estimate</span>
          <p className="text-gray-500 mt-4 text-sm">Score derived from technical signals. Hindered semantic reading.</p>
        </div>
        
        <div className="bg-[var(--color-brand-charcoal)] rounded-xl border border-white/5 p-6">
          <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mb-2 font-bold">SECTOR DOMINATION</div>
          <div className="text-4xl font-bold text-white mb-3">D</div>
          <div className="w-full bg-white/10 h-1 mb-3"><div className="w-1/4 bg-white h-full" /></div>
          <p className="text-gray-500 text-xs">Weight unobservable under these conditions.</p>
        </div>

        <div className="bg-[var(--color-brand-charcoal)] rounded-xl border border-white/5 p-6">
          <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mb-2 font-bold">CONCENTRATION INDEX</div>
          <div className="text-4xl font-bold text-white mb-3">28%</div>
          <div className="w-full bg-white/10 h-1 mb-3"><div className="w-1/4 bg-white h-full" /></div>
          <p className="text-gray-500 text-xs">Semantics not qualifyable as is.</p>
        </div>

        <div className="bg-[var(--color-brand-charcoal)] rounded-xl border border-white/5 p-6">
          <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mb-2 font-bold">SIMILARITY RATE</div>
          <div className="text-4xl font-bold text-white mb-3 tracking-tight">95%</div>
          <div className="w-full bg-white/10 h-1 mb-3"><div className="w-[95%] bg-[var(--color-brand-red)] h-full" /></div>
          <p className="text-gray-500 text-xs">Impossibility of establishing differentiation.</p>
        </div>

        <div className="bg-[var(--color-brand-charcoal)] rounded-xl border border-white/5 p-6">
          <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest mb-2 font-bold">MARKET STATUS</div>
          <div className="text-2xl font-bold text-gray-400 mb-3 tracking-tight">Undetermined</div>
          <div className="w-full bg-white/10 h-1 mb-3"><div className="w-[10%] bg-white/20 h-full" /></div>
          <p className="text-gray-500 text-xs">Insufficient data to rule.</p>
        </div>
      </div>

      <h3 className="text-3xl font-bold text-white mt-16 mb-8 flex items-center gap-4">
      ...
      <div className="bg-[var(--color-brand-charcoal)] rounded-2xl border border-white/5 p-8 md:p-12 mb-24 relative overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-8 pb-8 border-b border-white/5">
          <h3 className="text-3xl font-bold text-white relative z-10">The final word: your diagnosis</h3>
          <span className="text-[10px] font-mono text-gray-500 uppercase tracking-widest font-bold">AI SYNTHESIS</span>
        </div>
        <p className="text-xl md:text-2xl text-gray-300 font-medium italic leading-relaxed mb-12 relative z-10">
          "The analysis of <strong className="text-white">{result.url.replace('https://', '').split('/')[0]}</strong> reveals an exploitable base, but still too weak to establish itself as a priority source in engines and artificial intelligence."
        </p>

        <div className="grid md:grid-cols-3 gap-8 relative z-10">
          <div className="border-l-[3px] border-[var(--color-brand-green)] pl-6">
            <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest font-bold mb-3">OVERVIEW</div>
          ...
          <div className="border-l-[3px] border-yellow-500 pl-6">
            <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest font-bold mb-3">YOUR GREATEST ASSET</div>
            <p className="text-gray-300 text-sm leading-relaxed">The main content is easily accessible and can be interpreted by the crawling algorithm.</p>
          </div>
          <div className="border-l-[3px] border-[var(--color-brand-red)] pl-6">
            <div className="text-[10px] font-mono text-gray-500 uppercase tracking-widest font-bold mb-3">MAJOR AREA OF IMPROVEMENT</div>
            <p className="text-gray-300 text-sm leading-relaxed">The site still lacks editorial differentiation, trust signals and structured relays.</p>
          </div>
        </div>
      </div>
...
function ServerMetricCard({ label, value, sub, status }: { label: string, value: string, sub: string, status?: 'pass'|'fail'|'warn' }) {
  ...
  return (
    <div className="bg-[var(--color-brand-charcoal)] border border-white/5 rounded-xl p-5 flex flex-col justify-center">
...
function RoadmapCard({ timeframe, timeColor, title, desc, diagnosis, seoImp, aiImp, isFail }: any) {
  return (
    <div className="flex bg-[var(--color-brand-charcoal)] rounded-xl border border-white/5 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row w-full p-6 md:p-8 gap-8">
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="bg-[var(--color-brand-bg)] border border-white/5 p-4 rounded-lg text-sm text-gray-300">
            <span className="font-bold text-white">Diagnosis: </span> {diagnosis}
          </div>
          <div className="flex gap-3 text-[10px] font-mono tracking-widest font-bold">
            <span className={`px-2 py-1 rounded border ${isFail ? 'border-[var(--color-brand-red)]/30 text-[var(--color-brand-red)]' : 'border-white/10 text-gray-400'}`}>SEO IMPACT: {seoImp}</span>
            <span className="px-2 py-1 rounded border border-white/10 text-gray-400">AI IMPACT: {aiImp}</span>
          </div>
        </div>
      </div>
    </div>
...
function AuditSkeleton() {
  return (
    <div className="w-full max-w-6xl mx-auto mt-16 p-1 animate-pulse space-y-8">
      <div className="bg-[var(--color-brand-charcoal)] h-64 rounded-2xl border border-white/5 relative overflow-hidden flex" />
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
